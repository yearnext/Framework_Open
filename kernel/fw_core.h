 ...
 *******************************************************************************
 */
#define Fw_BaseTimer_Start(tim, tick)                       _st((tim) = (tick);)
#define Fw_BaseTimer_Stop(tim)                                   _st((tim) = 0;)
#define Fw_BaseTimer_IsDone(tim)                                    ((tim) == 0)
#define Fw_BaseTimer_Handle(tim)               _st(if((tim) > 0)               \
                                               {                               \
                                                   --(tim);                    \
                                               })
#define Fw_BaseTimer_TimeoutPost(tim, id, evt) _st(if((tim) > 0)               \
                                               {                               \
                                                   if(!--(tim))                \
                                                   {                           \
                                                       Fw_Msg_Send(id, evt);   \
...
#define Fw_BaseTimer_TimeoutPostDrv(tim, evt)  _st(if((tim) > 0)               \
                                               {                               \
                                                   if(!--(tim))                \
                                                   {                           \
                                                       BSP_Msg_Send(evt);      \
